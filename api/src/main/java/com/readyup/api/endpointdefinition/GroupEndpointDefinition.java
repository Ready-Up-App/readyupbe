...
public interface GroupEndpointDefinition {
    ...
    ResponseEntity<Boolean> deleteGroup(@RequestHeader(name = "Authorization")String bearerToken, @RequestBody DeleteGroupRequest deleteRequest);
...
//    ResponseEntity<List<Group>> getAllGroups();
    ...
    ResponseEntity<LeaveGroupResponse> leaveGroup(@RequestHeader(name = "Authorization") String bearerToken, @RequestBody LeaveGroupRequest request);
}
